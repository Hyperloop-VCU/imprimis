...
#include <stdint.h>
#include <chrono>
#include "custom_mppi_controller/controller.hpp"
  ...
  const std::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap_ros)
{
  ...
  RCLCPP_INFO(logger_, "\n\n\n HELLO FROM CUSTOM MPPI CONTROLLER \n\n\n");
}
...
PLUGINLIB_EXPORT_CLASS(custom_mppi_controller::MPPIController, nav2_core::Controller)

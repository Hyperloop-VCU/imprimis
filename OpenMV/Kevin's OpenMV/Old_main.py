...
#COLOR_THRESHOLDS = [(200, 255, 100, 160, 100, 160)] # White Line
COLOR_THRESHOLDS = [(200, 255, 200, 255, 200, 255)]  # White Line.


GRAYSCALE_THRESHOLDS = [(245, 255)] # White
#GRAYSCALE_THRESHOLDS = [(240, 255)] # White
...
GRAYSCALE_HIGH_LIGHT_THRESHOLDS = [(200, 255)]
...
AREA_THRESHOLD = 100 # Raise to filter out false detections.
